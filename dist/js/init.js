...
/*Chat Panel Toggle*/
$(document).on('click', '#chats_toggle_btn', function (e) {
	$wrapper.toggleClass('hk-chats-toggle');
	return false;
});
$(document).on('click', '#chats_panel_close', function (e) {
	$wrapper.removeClass('hk-chats-toggle');
	return false;
});